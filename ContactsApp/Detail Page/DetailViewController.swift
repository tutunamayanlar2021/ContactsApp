...
class DetailViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        let layout = UICollectionViewFlowLayout()
               ...
               layout.itemSize = CGSize(width: 100, height: 150) // Ayarlamak istediğiniz hücre boyutlarına göre değerleri burada değiştirebilirsiniz.
        ...
        cantactTypeCollectionView.dataSource = self // Set the data source for the UICollectionView
    ...
    private func setupUI() {
        ...
        // Filter the contacts based on selectedContactType and store them in filteredContacts
